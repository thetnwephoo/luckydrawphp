<?php
  $conn = mysqli_connect("localhost", "root", "", "aungpyae_lucky_draw");
    ...
    <div class="row">
      <div class="col-4 offset-md-4" style="margin-top: 30px;">
        ...
        <table class="table table-bordered">
          <thead>
            <th>Profile_images</th>
            <th>Remark</th>
          </thead>
          <tbody>
            <?php foreach ($users as $user): ?>
              <tr>
                <td> <img src="<?php echo 'images/' . $customers['profile_image'] ?>" width="90" height="90" alt=""> </td>
                <td> <?php echo $customers['remark']; ?> </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
